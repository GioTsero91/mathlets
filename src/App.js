...
import {ChatModal} from "./components/common/organisms/chat-modal";
import ChatModalContext from "./components/common/organisms/chat-modal";
...
function App() {
  ...
  return (
    <BotModalContext.Provider value={{
      ...
      <ChatModalContext.Provider value={{
        chatModalOpen,
        setChatModalOpen
      }}>
        <div id="main">
          ...
          <img
            ...
            className={"fixed right-[20px] bottom-[20px] z-[5] cursor-pointer"}
            src={require("assets/images/icons/common/chat-icon.svg").default}>
