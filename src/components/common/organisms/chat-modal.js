...
export const ChatModal = () => {
  ...
  return <div className={"flex gap-[30px] transition-all ease-in-out duration-300 fixed bottom-[100px] right-[20px] z-[5] " +
    ...
    <div
      ...
      className={"shadow-[0_0px_20px_5px_rgba(0,0,0,0.3)] bg-accent " +
